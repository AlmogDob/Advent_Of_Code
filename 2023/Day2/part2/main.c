...
int main(int argc, char const *argv[])
{
    ...
    int current_line_length, success, sum_of_powers = 0,
    max_num_of_red, max_num_of_green, max_num_of_blue,
    current_num = 0, current_power = 0;
    ...
    while ((current_line_length = get_line(fp, str)) != -1) {
        ...
        current_power = max_num_of_red * max_num_of_green * max_num_of_blue;
        sum_of_powers += current_power;
    }

    dprintINT(sum_of_powers);
